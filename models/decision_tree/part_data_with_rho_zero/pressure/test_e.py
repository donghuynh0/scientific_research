...
from utils.setup import load_augmented_data_with_energy
from utils.evaluate_model import evaluate
from utils.plot_scatter import plot_relative_error

# load data
train_data, test_data = load_augmented_data_with_energy()

X_train = train_data[['T*', 'rho*', 'energy']]
y_train = train_data['D* x rho*']
X_test = test_data[['T*', 'rho*', 'energy']]
